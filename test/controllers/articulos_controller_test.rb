...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { descripcion: @articulo.descripcion, palabras_claves: @articulo.palabras_claves, titulo: @articulo.titulo }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { descripcion: @articulo.descripcion, palabras_claves: @articulo.palabras_claves, titulo: @articulo.titulo }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
